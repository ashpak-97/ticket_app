...
if ($response == "UNIQUE_CODE") {
    ...
    if (isset($_GET["mode"]) && isset($_GET["status"]) && isset($_GET["id"])) {
        ...
        $valid_modes = array('USERS', 'HOTEL', 'ROOM_TYPE', 'TARIFF', 'RM_CONTACTS', 'PROPERTY', 'BLOCKBOOKING_LIST', 'BLOCKBOOKING_HOTELROOM', 'BLOCKBOOKING_HOTELROOM_RM', 'COUNTRY', 'LOCATION', 'CURRENCYDENOM', 'LEVELS', 'CHIPTYPE', 'CHIPDENOM', 'TABLE', 'CAGE', 'VENDORUSERS', 'NL_CLUBS', 'AFUSERS', 'VILLA', 'NL_TICKETS');
        if (in_array($mode, $valid_modes)) {
            if ($mode == 'USERS') {
                ...
                $tbl = 'property';
                $msg = 'Property';
            } elseif ($mode == 'BLOCKBOOKING_LIST') {
                $pk_fld = 'iBlockID';
                $tbl = 'concblock';
                $msg = 'Block Booking';
            } elseif ($mode == 'BLOCKBOOKING_HOTELROOM') {
                $pk_fld = 'iBlockDatID';
                $tbl = 'concblock_dat';
                $msg = 'Block Booking Hotel/Room';
            } elseif ($mode == 'BLOCKBOOKING_HOTELROOM_RM') {
                $pk_fld = 'iBlockDatDisID';
                $tbl = 'concblock_dat_distribution';
                $msg = 'Block Booking Hotel/Room Distribution';
            } elseif ($mode == 'COUNTRY') {
                $pk_fld = 'iCountryID';
                $tbl = 'country';
                $msg = 'Country';
                ...
                $tbl = 'level';
                $msg = 'Levels';
            } elseif ($mode == 'CHIPTYPE') {
                $pk_fld = 'iChipTypeID';
                $tbl = 'chiptype';
                $msg = 'Chiptype';
            } elseif ($mode == 'CHIPDENOM') {
                $pk_fld = 'iCDID';
                $tbl = 'chipdenom';
                $msg = 'Chipdenom';
            } elseif ($mode == 'TABLE') {
                ...
                $tbl = 'casinocage';
                $msg = 'casinocage';
            } elseif ($mode == 'VENDORUSERS') {
                $pk_fld = 'iVendorID';
                $tbl = 'vendor';
                $msg = 'Vendor';
            } elseif ($mode == 'NL_CLUBS') {
                $pk_fld = 'iClubID';
                $tbl = 'nl_club';
                $msg = 'Club';
            } elseif ($mode == 'AFUSERS') {
