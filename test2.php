                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="login-box-msg"><strong> You have selected following zips in your coverage</strong></p>
                                ...
                                <form id="regForm" action="register.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="tab">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea rows="4" cols="50" class="form-control invalid" placeholder="Company Address" name="address" id="address" required>
                                            </textarea>
                                        </div>
